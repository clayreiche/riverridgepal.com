                ...
                <tbody>
                    <tr valign="top">   
                        ...
                        <td>
                            ...
                            <?php } ?>
                            <br />
                            <i style="color: #666; font-size: 11px;"><?php _e('The license key you received when you purchased the plugin.'); ?></i>
                            <br /><a href="http://smashballoon.com/custom-facebook-feed/support" target="_blank"><?php _e('Upgrade or renew my license'); ?></a>
                        </td>
                    </tr>
                </tbody>
            </table>
...
function cff_settings_page() {
    ...
    <div id="cff-admin" class="wrap">
                ...
                <tbody>
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            <p class="cff-tooltip"><?php _e("In order to use the plugin, Facebook requires you to obtain an access token to verify that you're authorized to access their data.  Don't worry though, this is really easy to do.  Just follow these <a href='http://smashballoon.com/custom-facebook-feed/access-token/' target='_blank'>step-by-step instructions</a>"); ?>.</p>
                        </td>
                    </tr>
                    <tr valign="top">
                        <th scope="row"><?php _e('Facebook Page ID'); ?><br /><i style="color: #666; font-size: 11px;"><?php _e('(This can usually be found in your <a class="cff-tooltip-link" href="JavaScript:void(0);">Facebook page URL</a>)</i>'); ?></th>
                        <td>
        ...
        <p>[custom-facebook-feed <b><span style='color: green;'>num=3 layout=thumb height=500px</span></b>]</p>
        ...
        <form name="form1" method="post" action="">
                    ...
                    <tr valign="top" id="post-types">
                        ...
                        <td>
                            ...
                            <div>
                                ...
                                <div class="cff-events-source">
                                    <div class="row">
                                        <p><i style="color: #666; font-size: 11px; margin-bottom: 10px; display:block;"><?php _e('These options are only available if Events is the only post type selected.'); ?></i></p>
                                        ...
                                        <div class="cff-tooltip"><?php _e("<p><b>Events page</b><br />Events displayed from your Events page are in chronological order, have larger images and slightly more information available for each event. However, only upcoming events can be shown, past events cannot be shown using this method.</p>
                ...
                <tbody>
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            <span><i style="color: #666; font-size: 11px;"><?php _e('Only display posts containing this text string. Separate multiple strings using commas.'); ?></i></span>
                        </td>
                    </tr>
                </tbody>
            </table>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="cff_preset_layout">
                                <option value="thumb" <?php if($cff_preset_layout == "thumb") echo 'selected="selected"' ?> ><?php _e('Thumbnail'); ?></option>
                                <option value="half" <?php if($cff_preset_layout == "half") echo 'selected="selected"' ?> ><?php _e('Half-width'); ?></option>
                                <option value="full" <?php if($cff_preset_layout == "full") echo 'selected="selected"' ?> ><?php _e('Full-width'); ?></option>
                            </select>
                        </td>
                    </tr>
                    <tr valign="top">
            ...
            <table class="form-table">
                <tbody>
                    ...
                    <!-- <tr valign="top">
                        ...
                        <td>
                            <label for="cff_nocomments_text"><?php _e('Display this text:'); ?></label>
                            ...
                            <label for="cff_hide_comments"><?php _e('Hide the dropdown comments box'); ?></label>
                        </td>
                    </tr> -->
                </tbody>
            </table>
            ...
            <table class="form-table">
                <tbody>
                    ...
                    <!-- <tr valign="top">
                        <th class="bump-left" scope="row"><label><?php _e('Embedded Video Height Override'); ?></label></th>
                        <td>
                            <input name="cff_video_height" type="text" value="<?php esc_attr_e( $cff_video_height ); ?>" size="10" /> <span>Eg. 300px <i style="color: #666; font-size: 11px; margin-left: 5px;"><?php _e('Use this if you wish to override the default video height'); ?></i></span>
                        </td>
                    </tr> -->
                    <tr valign="top">
...
function cff_admin_scripts() {
    wp_enqueue_script( 'cff_admin_script', plugin_dir_url( __FILE__ ) . 'js/cff-admin-scripts.js?3' );
